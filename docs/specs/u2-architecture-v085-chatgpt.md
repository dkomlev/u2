...
- с планом разработки **«U2 — План для ИИ‑агентов 0.8.5 (ChatGPT)»**;
...
**Обломки** — состояние корабля после разрушения корпуса, когда он больше не управляется, но остаётся физическим объектом в мире.
